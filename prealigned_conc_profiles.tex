...
\end{itemize}
	...
	\begin{minipage}{0.45\textwidth}
		\includegraphics[width=0.9\textwidth]{dmaps_spiral.jpg}\\
		\centering
...
\begin{frame}{Using DMAPS to Order Concentration Profiles}
  ...
  \begin{tikzpicture}
    ...
    \draw [->] (unordered.east) -- (ordered.west) node[above,midway, text width=0.2\textwidth] {{\small Ordered using the first DMAPS coordinate \par}};    
  \end{tikzpicture}
