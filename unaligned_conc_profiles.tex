...
\begin{frame}{Factoring Out Rotations}
	...
	\only<1>{\includegraphics[width=0.5\textwidth]{PU_template1_clean}\\
	{\small \em Images, unaligned.}}
	\only<2>{\includegraphics[width=0.5\textwidth]{PU_template2_clean}\\
	{\small \em Images, aligned to template.}}
...
\begin{frame}{Factoring Out Rotations}
	...
	\centering
	\only<1>{\includegraphics[width=0.5\textwidth]{PU_template1_noisy}\\
	{\small \em Images, unaligned, now corrupted with white Gaussian noise.}}
	\only<2>{\includegraphics[width=0.5\textwidth]{PU_template2_noisy}\\
	{\small \em Images, aligned to template.}}
	\only<3>{\includegraphics[width=0.5\textwidth]{PU_template3_noisy}\\
	{\small \em Images, denoised after being aligned to template. Note that there are several misalignments.}}
...
\begin{frame}{Factoring Out Rotations}
	...
	{\small \em Images, unaligned, now corrupted with white Gaussian noise.}}
	\only<2>{\includegraphics[width=0.5\textwidth]{PU_angsynch2}\\
	{\small \em Images, aligned using angular synchronization.}}
	\only<3>{\includegraphics[width=0.5\textwidth]{PU_angsynch3} \\
