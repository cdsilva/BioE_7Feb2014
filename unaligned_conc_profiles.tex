...
\begin{frame}{Importance of Symmetries in Data Analysis}
	...
	We must {\em factoring out} rotational symmetries before (or in conjunction with) ordering the images. 
...
\begin{frame}{Issues with Template Alignment: Consistency}
	...
	\centering
	\includegraphics[width=0.6\textwidth]{PU_consistency_noisy}\\
