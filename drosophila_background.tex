...
\begin{frame}{Fluorescent {\em Drosophila} Images}
	\foreach \i in {1,...,51} {	
	\includegraphics[width=0.05\textwidth]{dpERK_unaligned_\i}} 
	...
	\only<2>{
	\foreach \i in {15, 2, 46, 24, 29, 28, 4, 25, 16, 32, 37, 8, 40, 27, 3, 18, 26, 12, 7, 38, 21, 19, 5, 9, 17, 47, 22, 52, 14, 45, 33, 49, 20, 13, 1, 36, 6, 23, 11, 34, 51, 43, 30, 42, 48, 35, 44, 50, 10, 41, 31, 39} {
	\includegraphics[width=0.05\textwidth]{dpERK_aligned_\i}
	}
