...
\begin{frame}{Imaging Dorsoventral Patterns \footcite{chung2010microfluidic}}

	\centering
    \includegraphics[width=0.75\textwidth]{drosophila_imaging_setup}
    
	\begin{itemize}
        \item We can easily obtain dpERK concentration profiles for many embryos using a high--throughput microfluidic device
